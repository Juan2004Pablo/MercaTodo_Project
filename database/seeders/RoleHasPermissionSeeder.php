...
class RoleHasPermissionSeeder extends Seeder
{
    public const ADMINPERMISSIONS = [Resource::USER_INDEX, Resource::USER_UPDATE, Resource::USER_SHOW, Resource::USER_DISABLE, Resource::ROLE_INDEX,
        ...
        Resource::PRODUCT_UPDATE, Resource::PRODUCT_DISABLE, Resource::PRODUCTS_EXPORT, Resource::USERS_EXPORT, Resource::CATEGORIES_EXPORT, Resource::ROLES_EXPORT, Resource::CATEGORIES_IMPORT, Resource::ROLES_IMPORT, Resource::HOME_INDEX,];
